...
def default_image_catalog() -> List[ImageTemplate]:
    return [
        ...
        ImageTemplate(
            ...
            "Narzędzia / Pliki",
            "Prosty webowy menedżer plików z panelem do przeglądania, wysyłania i zarządzania danymi.",
            "filebrowser",
            "80",
            "8094",
            extra="-v filebrowser_data:/srv -v filebrowser_database:/database -v filebrowser_config:/config --restart unless-stopped",
            notes="Domyślnie zarządza danymi w volume filebrowser_data. Możesz później zamienić go na bind mount wybranego katalogu hosta.",
            lightweight=True,
            category_en="Tools / Files",
            description_en="Simple web file manager for browsing, uploading and managing files.",
            notes_en="By default it manages data in the filebrowser_data volume. You can later replace it with a bind mount to a chosen host directory.",
            source_url="https://github.com/filebrowser/filebrowser",
            docs_url="https://github.com/filebrowser/filebrowser/blob/master/docs/installation.md",
            homepage_url="https://filebrowser.org/",
            icon_text="FB",
            engines=["docker"],
        ),
        ImageTemplate(
        ...
        ImageTemplate("Uptime Kuma", "louislam/uptime-kuma:1", "Monitoring", "Monitoring stron i uslug z prostym dashboardem.", "uptime-kuma", "3001", "3002", extra="-v uptime_kuma:/app/data", notes="Bardzo lekki do domowego monitoringu.", category_en="Monitoring", description_en="Website and service monitoring with a simple dashboard.", notes_en="Very lightweight for home monitoring.", source_url="https://github.com/louislam/uptime-kuma", homepage_url="https://uptime.kuma.pet/", icon_text="UK"),
